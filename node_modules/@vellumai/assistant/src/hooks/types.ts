/**
 * Hook context shapes — the canonical home for the contexts the runtime
 ...
 * unscoped `hook_event`.
 */
export type HookBroadcast = (detail: Record<string, unknown>) => void;
...
export type AgentLoopExitReason =
  /** The turn hit the MAX_TOOL_USE_TURNS ceiling in the agent loop. */
  | "max_tool_turns"
